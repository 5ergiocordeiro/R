...
\centering
    \begin{tabular}{|c|c|c|c|}
		\hline
        \textbf{n} & \textbf{Hermite} & \textbf{Lagrange} & \textbf{custo} \tablefootnote{Número de operações de ponto flutuante necessárias.} \\
		\hline
...
Uma grande desvantagem da técnica é que cada ponto a ser interpolado exige o recálculo de todos as grandezas \cite{FREITAS 2010,TOBÓN 2011}. \\
\hlin
