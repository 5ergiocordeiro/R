% Calcula a distribuição de carga 'rho' nas placas de um capacitor plano de arestas 'aa' e 'bb', separadas por uma distância 'd', submetidas a uma diferença de potencial 'Vo', pelo método dos momentos, com 'n' subdivisões da região.
